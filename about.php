...
<?php get_header(); ?>
    ...
    <section class="about" id="about">
        ...
        <div class="moe-introduction">
            ...
            <p>
                1994年生まれ。幼少期からものづくりが好きで、事務員やパン屋さんとして働きながら、曲を作ったり、建築模型を作ったり、ハンドメイドのあみぐるみなどを作る活動をしていました。<br>
                <br>
                以前からデザインを本格的に勉強したかったこと、Webサイトのデザイン設計の面白さや、ユーザーアクションによって動く仕組みの作り方に惹かれ、職業訓練校で6ヶ月間Webデザインについて学びました。<br>
    ...
    <section class="skill" id="skill">
        ...
        <div class="skill-cotainer">
            <div class="skill_design">
                <h4>WEBデザイン</h4>
                <p>Webサイト、バナーの制作をすることができます。ユーザーにとって使いやすいシンプルなデザインを心がけながら、心地よくサイトを閲覧していただけるデザインになるように作り込むようにしています。
                </p>
            </div>
            <div class="skill_development">
                <h4>WEB開発</h4>
                <p>デザインカンプを忠実に再現することが出来、レスポンシブ対応も可能です。また、規則性のある命名を行い、誰が見ても分かりやすいコードを書くことを心がけています。JavaScriptを利用して、ユーザーアクションによって動くWebサイトを作ることができます。</p>
            </div>
        </div>
    </section>
